...
public class ColumnFamilyDefinition implements org.apache.thrift.TBase<ColumnFamilyDefinition, ColumnFamilyDefinition._Fields>, java.io.Serializable, Cloneable {
  ...
  public ColumnDefinition defaultDefinition;
  public Map<String,ColumnDefinition> columnDefinitions;
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.columnDefinitions = new HashMap<String,ColumnDefinition>(2*_map5.size);
              for (int _i6 = 0; _i6 < _map5.size; ++_i6)
              {
                String _key7;
                ColumnDefinition _val8;
                _key7 = iprot.readString();
                _val8 = new ColumnDefinition();
                _val8.read(iprot);
                this.columnDefinitions.put(_key7, _val8);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.columnDefinitions != null) {
      oprot.writeFieldBegin(COLUMN_DEFINITIONS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, ColumnDefinition> _iter9 : this.columnDefinitions.entrySet())
        {
