            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.shardsToUris = new HashMap<String,String>(2*_map72.size);
                for (int _i73 = 0; _i73 < _map72.size; ++_i73)
                {
                  ...
                  this.shardsToUris.put(_key74, _val75);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.shardsToUris != null) {
        oprot.writeFieldBegin(SHARDS_TO_URIS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter76 : this.shardsToUris.entrySet())
          {
