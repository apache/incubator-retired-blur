        ...
        module Generated
                    ...
                    class BlurQuery
                      ...
                      FIELDS = {
                        ...
                        TYPE => {:type => ::Thrift::Types::I32, :name => 'type', :default =>                         0, :enum_class => Com::Nearinfinity::Blur::Thrift::Generated::ScoreType},
                        ...
                        FACETS => {:type => ::Thrift::Types::LIST, :name => 'facets', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::Facet}}
                      }

                      def struct_fields; FIELDS; end

                      def validate
                        unless @type.nil? || Com::Nearinfinity::Blur::Thrift::Generated::ScoreType::VALID_VALUES.include?(@type)
                    ...
                    class BlurQuerySuggestion
                      ...
                      FIELDS = {
                        ...
                        EXCEPTIONS => {:type => ::Thrift::Types::LIST, :name => 'exceptions', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurException}},
                        QUERY => {:type => ::Thrift::Types::STRUCT, :name => 'query', :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurQuery},
                    ...
                    class BlurQuerySuggestions
                      ...
                      FIELDS = {
                        QUERYSUGGESTIONS => {:type => ::Thrift::Types::LIST, :name => 'querySuggestions', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurQuerySuggestion}}
                      }
                    ...
                    class BlurResults
                      ...
                      FIELDS = {
                        TOTALRESULTS => {:type => ::Thrift::Types::I64, :name => 'totalResults', :default => 0},
                        SHARDINFO => {:type => ::Thrift::Types::MAP, :name => 'shardInfo', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::I64}},
                        RESULTS => {:type => ::Thrift::Types::LIST, :name => 'results', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurResult}},
                        EXCEPTIONS => {:type => ::Thrift::Types::LIST, :name => 'exceptions', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurException}},
                        QUERY => {:type => ::Thrift::Types::STRUCT, :name => 'query', :class => Com::Nearinfinity::Blur::Thrift::Generated::BlurQuery},
                        REALTIME => {:type => ::Thrift::Types::I64, :name => 'realTime'},
                        CPUTIME => {:type => ::Thrift::Types::I64, :name => 'cpuTime'},
                    ...
                    class ColumnFamily
                      ...
                      FIELDS = {
                        ...
                        RECORDS => {:type => ::Thrift::Types::MAP, :name => 'records', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::SET, :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::Column}}}
                      }
                    ...
                    class Row
                      ...
                      FIELDS = {
                        ...
                        COLUMNFAMILIES => {:type => ::Thrift::Types::SET, :name => 'columnFamilies', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::ColumnFamily}}
                      }
                    ...
                    class FetchRowResult
                      ...
                      FIELDS = {
                        ROW => {:type => ::Thrift::Types::STRUCT, :name => 'row', :class => Com::Nearinfinity::Blur::Thrift::Generated::Row}
                      }
                    ...
                    class FetchRecordResult
                      ...
                      FIELDS = {
                        ...
                        RECORD => {:type => ::Thrift::Types::SET, :name => 'record', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::Column}}
                      }
                    ...
                    class FetchResult
                      ...
                      FIELDS = {
                        ...
                        ROWRESULT => {:type => ::Thrift::Types::STRUCT, :name => 'rowResult', :class => Com::Nearinfinity::Blur::Thrift::Generated::FetchRowResult},
                        RECORDRESULT => {:type => ::Thrift::Types::STRUCT, :name => 'recordResult', :class => Com::Nearinfinity::Blur::Thrift::Generated::FetchRecordResult}
                      }
                    ...
                    class RecordMutation
                      ...
                      FIELDS = {
                        RECORDMUTATIONTYPE => {:type => ::Thrift::Types::I32, :name => 'recordMutationType', :enum_class => Com::Nearinfinity::Blur::Thrift::Generated::RecordMutationType},
                        FAMILY => {:type => ::Thrift::Types::STRING, :name => 'family'},
                        RECORDID => {:type => ::Thrift::Types::STRING, :name => 'recordId'},
                        RECORD => {:type => ::Thrift::Types::SET, :name => 'record', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::Column}}
                      }
                      ...
                      def validate
                        unless @recordMutationType.nil? || Com::Nearinfinity::Blur::Thrift::Generated::RecordMutationType::VALID_VALUES.include?(@recordMutationType)
                    ...
                    class RowMutation
                      ...
                      FIELDS = {
                        ROWMUTATIONTYPE => {:type => ::Thrift::Types::I32, :name => 'rowMutationType', :enum_class => Com::Nearinfinity::Blur::Thrift::Generated::RowMutationType},
                        ROWID => {:type => ::Thrift::Types::STRING, :name => 'rowId'},
                        RECORDMUTATIONS => {:type => ::Thrift::Types::LIST, :name => 'recordMutations', :element => {:type => ::Thrift::Types::STRUCT, :class => Com::Nearinfinity::Blur::Thrift::Generated::RecordMutation}}
                      }

                      def struct_fields; FIELDS; end

                      def validate
                        unless @rowMutationType.nil? || Com::Nearinfinity::Blur::Thrift::Generated::RowMutationType::VALID_VALUES.include?(@rowMutationType)
