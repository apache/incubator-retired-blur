...
public class ColumnDefinition implements org.apache.thrift.TBase<ColumnDefinition, ColumnDefinition._Fields>, java.io.Serializable, Cloneable {
  ...
  public Map<String,AlternateColumnDefinition> alternateColumnDefinitions;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case FULL_TEXT_INDEX:
      return new Boolean(isFullTextIndex());
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.alternateColumnDefinitions = new HashMap<String,AlternateColumnDefinition>(2*_map0.size);
              for (int _i1 = 0; _i1 < _map0.size; ++_i1)
              {
                String _key2;
                AlternateColumnDefinition _val3;
                _key2 = iprot.readString();
                _val3 = new AlternateColumnDefinition();
                _val3.read(iprot);
                this.alternateColumnDefinitions.put(_key2, _val3);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.alternateColumnDefinitions != null) {
      oprot.writeFieldBegin(ALTERNATE_COLUMN_DEFINITIONS_FIELD_DESC);
      {
        ...
        for (Map.Entry<String, AlternateColumnDefinition> _iter4 : this.alternateColumnDefinitions.entrySet())
        {
