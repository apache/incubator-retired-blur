  ...
  factory :zookeeper do
    ...
    factory :zookeeper_with_cluster do
      after_create do |zookeeper|
        FactoryGirl.create_list(:controller, 1, :zookeeper => zookeeper)
    ...
    factory :zookeeper_with_clusters do
      after_create do |zookeeper, evaluator|
        FactoryGirl.create_list(:controller, evaluator.recursive_factor, :zookeeper => zookeeper)
    ...
    factory :zookeeper_with_blur_table, :parent => :zookeeper_with_cluster do
      after_create do |zookeeper|
        ...
        zookeeper.clusters.each { |cluster| FactoryGirl.create(:shard, :cluster => cluster) }
      end
    end
    ...
    factory :zookeeper_with_blur_tables, :parent => :zookeeper_with_cluster do
      after_create do |zookeeper, evaluator|
        ...
        zookeeper.clusters.each { |cluster| FactoryGirl.create_list(:shard, evaluator.recursive_factor, :cluster => cluster) }
      end
    end
