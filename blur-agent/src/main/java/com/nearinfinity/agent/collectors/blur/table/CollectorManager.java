...
public class CollectorManager implements Runnable {
  private static final Log log = LogFactory.getLog(CollectorManager.class);

  private final Iface connection;
  private final String zookeeper;
  private final TableDatabaseInterface database;

  public CollectorManager(Iface connection, String zookeeperName, TableDatabaseInterface jdbc) {
