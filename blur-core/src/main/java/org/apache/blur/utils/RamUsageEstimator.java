...
public final class RamUsageEstimator {
  ...
  private static ClassNameFilter classNameFilter = new ClassNameFilter() {
    @Override
  ...
  public static long sizeOf(Object obj) {
    return measureObjectSize(obj,classNameFilter);
  }
  
  public static long sizeOf(Object obj, ClassNameFilter filter) {
   ...
   * so not too much).  
   */
  private static long measureObjectSize(Object root, ClassNameFilter classNameFilter) {
    // Objects seen so far.
    ...
    while (!stack.isEmpty()) {
      ...
      if (!classNameFilter.include(className)) {
      continue;
      }
